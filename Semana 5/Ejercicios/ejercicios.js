...
//1
const personas = [
    {nombre: "Lean", apellido: "Contestabile", edad: 22},
    {nombre: "Lionel", apellido: "Messi", edad: 36},
    {nombre: "Rafael", apellido: "Nadal", edad: 38}
];

const escuderias = [
    {nombre: "Ferrari", sede: "Maranello", pilotoUno: "Leclerc", pilotoDos: "Sainz", puntosConstructores: 252},
    {nombre: "Red Bull", sede: "Milton Keynes", pilotoUno: "Verstappen", pilotoDos: "Perez", puntosConstructores: 301},
    {nombre: "McLaren", sede: "Surrey", pilotoUno: "Norris", pilotoDos: "Piastri", puntosConstructores: 212},
    {nombre: "Mercedes AMG", sede: "Brackley", pilotoUno: "Hamilton", pilotoDos: "Russell", puntosConstructores: 124}
];
...
class Alumno {
    ...
    presentarAlumno() {
        alert(`Buenos días. Mi nombre es ${this.apellido} ${this.nombre}, tengo ${this.edad} años y mi correo es ${this.correo}`);
    }
}
...
function pedirDatos() {
    ...
    datos[2] = prompt("Edad");
    datos[3] = prompt("Correo");
    return datos;
}

let datosAlumno = [];
datosAlumno = pedirDatos();
const alumno1 = new Alumno(datosAlumno[0], datosAlumno[1], datosAlumno[2], datosAlumno[3]);
console.log(alumno1);
