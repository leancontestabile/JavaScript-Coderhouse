...
/*
class Escuderia{
    constructor(nombre, sede, pilotoUno, pilotoDos, puntosConstructor){
        this.nombre = nombre;
        this.sede = sede;
        this.pilotoUno = pilotoUno;
        this.pilotoDos = pilotoDos;
        this.puntosConstructor = puntosConstructor;
    }
}

const escuderia1 = new Escuderia("Ferrari", "Maranello", "Leclerc", "Sainz", 255);
*/
